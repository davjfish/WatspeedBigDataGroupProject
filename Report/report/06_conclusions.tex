...
\begin{enumerate}
    ...
    \item{
        ...
        The code in the router will dictate which database instance should handle a specific query.
        For example, all INSERT, UPDATE and DELETE operations are routed to the primary database, while all SELECT operations are routed to one of the replicas
        at random---optimizing overall performance.
    }
\end{enumerate}
