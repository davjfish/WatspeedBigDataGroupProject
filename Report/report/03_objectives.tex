...
outline some approaches for ways these data can be disseminated to stakeholders.
...
(e.g., should only have a single entry for a specific zip code in a \texttt{ZipCode} table) or between columns
(e.g., combinations of \texttt{city}, \texttt{state} and \texttt{country} should be unique in an \texttt{AdministrativeArea} table).
